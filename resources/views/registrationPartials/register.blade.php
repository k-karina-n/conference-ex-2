        ...
        <div class="overflow-hidden shadow sm:rounded-md">
            <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                <div class="grid gap-4 lg:gap-6">
                    ...
                    <form hx-post="/" hx-trigger="submit" hx-target="#parent-div" hx-swap="innerHTML"
                        ...
                        <div x-data="{
                            ...
                            <div x-data="{ currentStep: $persist('first') }">
                                <div x-show="currentStep === 'first'"
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                                        ...
                                        <div class="mt-2 space-y-2">
                                            ...
                                            <input type="tel" name="phone" id="phone" x-model="form.phone"
                                                x-data x-mask="+99 (999) 999-9999" placeholder="+NN (NNN) NNN-NNNN"
                                                class="py-3 px-4 block w-full rounded-md border border-gray-200 rounded-md text-sm hover:border-blue-500 focus:border-blue-500 focus:ring-blue-500">
                                        </div>

                                        <div class="mt-2 space-y-2">
                                            <label for="email"
                                                class="block text-sm text-gray-700 font-medium">Email</label>
                                    ...
                                    <div class="mt-2 space-y-2">
                                        <label for="country"
                                            class="block text-sm text-gray-700 font-medium">Country</label>
                                ...
                                <div x-show="currentStep === 'second'"
                                    ...
                                    <div class="mt-2 space-y-2">
                                        <label for="description"
                                            class="block text-sm text-gray-700 font-medium">Conference
                                            decription</label>
                                        <div class="mt-2 space-y-2">
                                            <textarea id="description" name="description" type="text" x-model="form.description"
                                                ...
                                                rows="3" placeholder="Description (up to 1000 characters)" maxlength="1000" required>
                                                </textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-2 space-y-2">
                                        <label for="date"
                                            class="block text-sm text-gray-700 font-medium">Date</label>
                                        <div class="mt-2 space-y-2">
                                            @php($date = date('Y-m-d'))
