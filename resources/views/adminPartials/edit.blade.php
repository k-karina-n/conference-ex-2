            ...
            <div class="grid gap-4 lg:gap-6">
                ...
                <form hx-post="/update_speaker/{{ $user->id }}" hx-trigger="submit" hx-target="#parent-div" hx-swap="innerHTML" enctype="multipart/form-data">
                    ...
                    <div class="mt-2 space-y-2">
                        ...
                        <div class="mt-2 space-y-2">
                            <input id="title" name="title" type="text" value="{{ $conference->title }}" class="py-3 px-4 block w-full rounded-md border border-gray-200 rounded-md text-sm hover:border-blue-500 focus:border-blue-500 focus:ring-blue-500" required>
                        </div>
                    </div>
                    ...
                    <div class="mt-2 space-y-2">
                        ...
                        <div class="mt-2 space-y-2">
                            <textarea id="description" name="description" type="text" class="py-3 px-4 block w-full rounded-md border border-grcharactersay-200 rounded-md text-sm hover:border-blue-500 focus:border-blue-500 focus:ring-blue-500" rows="3" maxlength="1000" required>{{ $conference->description }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="mt-2 space-y-2">
                        ...
                        <div class="mt-2 space-y-2">
                            @php($date = date('Y-m-d'))
                            <input type="date" name="date" id="date" value="{{ $conference->date }}" min="{{ $date }}" class="py-3 px-4 block w-full rounded-md border border-gray-200 rounded-md text-sm hover:border-blue-500 focus:border-blue-500 focus:ring-blue-500">
                        </div>
                    </div>
